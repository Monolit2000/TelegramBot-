...
string apiKey = "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";
...
async Task SendAndSplitSendVoiceMessage(string apiKey, string ffmpegPath, Telegram.Bot.Types.Message message, string inputFile, int duration, int v)
{
    ...
    await SendAudioWithText(apiKey, SplitedAudioList, message, gorilla_GIF);
}
...
async Task SendAudioWithText(string apiKey, List<string> splitedAudioList, Telegram.Bot.Types.Message message,  string gorillaGIF)
{
    int partNumber = 0;
